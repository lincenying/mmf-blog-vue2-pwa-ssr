...
export function timeAgo(time) {
    ...
    if (between < 60)
        ...
        return pluralize(Number.parseInt(between / 60, 10), ' 分钟前')
    else if (between < 86400)
        return pluralize(Number.parseInt(between / 3600, 10), ' 小时前')

    return pluralize(Number.parseInt(between / 86400, 10), ' 天前')
}
