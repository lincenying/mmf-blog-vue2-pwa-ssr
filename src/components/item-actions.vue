<template>
    <div class="actions-wrap">
        <a v-if="item.like_status" href="javascript:;" class="action-item active" @click="handleLike"><i class="icon icon-action-voteup-active"></i><span class="text">{{ item.like }} 赞</span></a>
        <a v-else href="javascript:;" class="action-item" @click="handleLike"><i class="icon icon-action-voteup"></i><span class="text">{{ item.like }} 赞</span></a>
