...
var cacheName = 'sw-cache-mmf-blog-vue2-pwa-ssr'
...
var tmpArr = []
self.__precacheManifest.forEach(function(item) {
    if (item['url'] !== '/index.html') {
        var relativeUrl = item['url'];
        var hash = item['revision'];
        var absoluteUrl = new URL(relativeUrl, self.location);
        var cacheKey = createCacheKey(absoluteUrl, hashParamName, hash, '');
        tmpArr.push([absoluteUrl.toString(), cacheKey])
    }
})
